...
class ConfluenceCli < Formula
  ...
  on_macos do
    if Hardware::CPU.intel?
      ...
      sha256 "97e764e47ba25ffef6098e5b2d0a0954974c1adcf3ae2906bae96f3693da6860"
    ...
    if Hardware::CPU.arm?
      ...
      sha256 "4cb988ec6ed60a8d1584f7020bf81957f790901c7685cdc51a12482a835359c9"
  ...
  on_linux do
    if Hardware::CPU.intel?
      if Hardware::CPU.is_64_bit?
        ...
        sha256 "274eaa7b78f02bc22a66eaeb673068dc0c1d93b1277ec1de59b98a1264671355"
